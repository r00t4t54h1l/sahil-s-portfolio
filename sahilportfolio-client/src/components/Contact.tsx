...
export function Contact() {
  return (
    <footer id="contact" className="scroll-mt-24 border-t border-white/10 px-6 py-10">
      <div className="container mx-auto max-w-6xl">
        <div className="mb-12 text-center">
          <h2 className="mb-6 text-4xl font-bold text-white lg:text-5xl">
            Contact
          </h2>
          <p className="text-md mx-auto mb-8 max-w-2xl text-white/80">
            I&apos;m currently looking to join a cross-functional team that
            values improving people&apos;s lives through hardware-aware
            software, or have a project in mind? Let&apos;s connect.
          </p>
          <a
            href={`mailto:${site.email}`}
            className="text-md text-purple-400 transition-colors hover:text-purple-300"
          >
            {site.email}
          </a>
        </div>
